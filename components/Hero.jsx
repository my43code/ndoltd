    ...
    <section className="bg-gradient-to-r from-slate-950 via-slate-900 to-emerald-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-24 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="animate-fade-in-left">
          <span className="inline-block bg-yellow-400/20 text-yellow-300 px-4 py-2 rounded-full text-sm mb-6 border border-yellow-400/30 animate-fade-in-up hover:scale-105 transition-transform">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight tracking-tight animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
            Building <span className="text-gradient">Smart Technology</span> Solutions for PNG Businesses
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
            <Link
              href="/services"
              className="bg-emerald-600 hover:bg-emerald-700 px-6 py-3 rounded-full font-medium transition shadow-lg hover:shadow-emerald-500/50 hover:scale-105 hover:glow-pulse btn-glow"
            >
              Explore Services
            </Link>
            ...
            <Link
              href="/contact"
              className="border border-yellow-400 text-yellow-300 hover:bg-yellow-400 hover:text-black px-6 py-3 rounded-full font-medium transition hover:shadow-lg hover:scale-105 link-hover"
            >
              Contact Us
            </Link>
          </div>
